...
export function createSmokeSummary(input: SmokeSummaryInput): Record<string, unknown> {
  ...
  return {
    ...
    listedPortfolioMarketValue: input.record?.inputs.listedPortfolioMarketValue,
    listedPortfolioMarketValueSource: normalizedSourceFor(input.record, 'listedPortfolioMarketValue'),
    listedPortfolioCostValue: input.record?.inputs.listedPortfolioCostValue,
    listedPortfolioCostValueSource: normalizedSourceFor(input.record, 'listedPortfolioCostValue'),
    unlistedPortfolioSurplus: input.record?.inputs.unlistedPortfolioSurplus,
    unlistedPortfolioSurplusSource: normalizedSourceFor(input.record, 'unlistedPortfolioSurplus'),
